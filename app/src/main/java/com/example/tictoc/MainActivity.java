...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView texviewplayer2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textviewplayer1=findViewById(R.id.view_player_1);
        texviewplayer2=findViewById(R.id.view_player_2);
    ...
    private void updatePointstext(){
        ...
        texviewplayer2.setText("Player 2: "+player2points);
